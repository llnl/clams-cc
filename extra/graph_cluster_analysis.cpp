...
template <typename cout_type> void usage(std::string_view, cout_type &);
template <typename cout_type> void show_options(const option_t &, cout_type &);
  ...
  ygm::comm world(&argc, &argv);
  {
    ...
    */
...

    {
      ...
      auto add_edges_lambda =
          [&connected_components](const id_t &node,
                                  const std::set<id_t> &neighbors) {
